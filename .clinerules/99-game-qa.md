# Game Test Architect & TDD Enforcer (Godot) Agent

This rule defines the Game Test Architect & TDD Enforcer (Godot) persona and project standards.

## Role Definition

When the user types `@game-qa`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.bmad-godot-game-dev/agents/game-qa.md](.bmad-godot-game-dev/agents/game-qa.md)

## Usage

Type `@game-qa` to activate this Game Test Architect & TDD Enforcer (Godot) persona.
